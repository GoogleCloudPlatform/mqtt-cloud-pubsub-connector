...
public class OneLevelWildcardMqttSubscriptionProfile extends AbstractMqttToCloudPubSubTest {
  ...
  public String getConfigProfile() {
    return "one-level-wildcard-mqtt-subscription-profile";
  }

  @Override
  String getMqttTopicsToPublishTo() {
    return MQTT_TOPIC_ROOT_NAME
        + "/sub-topic-1/"
        + MQTT_SUB_SUB_TOPIC_NAME
        + ","
        + MQTT_TOPIC_ROOT_NAME
        + "/sub-topic-2/"
        + MQTT_SUB_SUB_TOPIC_NAME;
  }
  ...
  String getMqttTopicName() {
    return MQTT_TOPIC_ROOT_NAME + "/+/" + MQTT_SUB_SUB_TOPIC_NAME;
  }
}

...
# shellcheck disable=SC2034
TERRAFORM_BACKEND_CONFIGURATION_FILE_PATH="${TERRAFORM_ENVIRONMENT_DIR}/backend.tf"
# shellcheck disable=SC2034
...
TERRAFORM_CONTAINER_IMAGE_ID="$(grep <.devcontainer/Dockerfile "hashicorp/terraform" | awk -F ' ' '{print $2}')"

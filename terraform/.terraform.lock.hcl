...
provider "registry.terraform.io/hashicorp/google" {
  version     = "4.73.1"
  constraints = ">= 3.33.0, >= 3.39.0, >= 3.43.0, >= 3.45.0, >= 3.53.0, >= 3.83.0, >= 4.25.0, >= 4.32.0, >= 4.51.0, != 4.65.0, != 4.65.1, 4.73.1, < 5.0.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/google-beta" {
  version     = "4.73.0"
  constraints = ">= 3.43.0, >= 3.45.0, >= 4.51.0, != 4.65.0, != 4.65.1, 4.73.0, < 5.0.0"
  hashes = [
